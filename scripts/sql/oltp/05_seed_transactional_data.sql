...
DECLARE
    ...
    detail_data detail_tab := detail_tab(
        1 => detail_rec(9001, 7001, 6001, 10),
        2 => detail_rec(9002, 7001, 6004, 18),
        3 => detail_rec(9003, 7002, 6003, 13),
        4 => detail_rec(9004, 7002, 6005, 29),
        5 => detail_rec(9005, 7003, 6006, 111),
        6 => detail_rec(9006, 7003, 6007, 169),
        7 => detail_rec(9007, 7004, 6008, 550),
        8 => detail_rec(9008, 7004, 6002, 960),
        9 => detail_rec(9009, 7005, 6010, 45),
        10 => detail_rec(9010, 7005, 6009, 459),
        11 => detail_rec(9011, 7006, 6011, 236),
        12 => detail_rec(9012, 7006, 6005, 98),
        13 => detail_rec(9013, 7007, 6012, 156),
        14 => detail_rec(9014, 7007, 6013, 698),
        15 => detail_rec(9015, 7008, 6014, 445),
        16 => detail_rec(9016, 7008, 6022, 44),
        17 => detail_rec(9017, 7009, 6015, 77),
        18 => detail_rec(9018, 7009, 6020, 236),
        19 => detail_rec(9019, 7010, 6016, 158),
        20 => detail_rec(9020, 7010, 6017, 1458),
        21 => detail_rec(9021, 7011, 6018, 789),
        22 => detail_rec(9022, 7011, 6001, 889),
        23 => detail_rec(9023, 7012, 6021, 991),
        24 => detail_rec(9024, 7012, 6019, 456),
        25 => detail_rec(9025, 7013, 6023, 789),
        26 => detail_rec(9026, 7013, 6024, 654),
        27 => detail_rec(9027, 7014, 6025, 258),
        28 => detail_rec(9028, 7014, 6026, 369),
        29 => detail_rec(9029, 7015, 6027,441),
        30 => detail_rec(9030, 7015, 6003, 558),
        31 => detail_rec(9031, 7016, 6002, 335),
        32 => detail_rec(9032, 7016, 6005, 551),
        33 => detail_rec(9033, 7017, 6011, 876),
        34 => detail_rec(9034, 7017, 6013, 596),
        35 => detail_rec(9035, 7018, 6008, 896),
        36 => detail_rec(9036, 7018, 6010, 457),
        37 => detail_rec(9037, 7019, 6014, 332),
        38 => detail_rec(9038, 7019, 6009, 546),
        39 => detail_rec(9039, 7020, 6028, 413),
        40 => detail_rec(9040, 7020, 6029, 212),
        41 => detail_rec(9041, 7021, 6020, 145),
        42 => detail_rec(9042, 7021, 6004, 965),
        43 => detail_rec(9043, 7022, 6022, 987),
        44 => detail_rec(9044, 7022, 6023, 901),
        45 => detail_rec(9045, 7023, 6024, 907),
        46 => detail_rec(9046, 7023, 6025, 1000),
        47 => detail_rec(9047, 7024, 6026, 209),
        48 => detail_rec(9048, 7024, 6016, 295),
        49 => detail_rec(9049, 7025, 6007, 301),
        50 => detail_rec(9050, 7025, 6012, 987),
        51 => detail_rec(9051, 7026, 6008, 1235),
        52 => detail_rec(9052, 7026, 6001, 8523),
        53 => detail_rec(9053, 7027, 6003, 456),
        54 => detail_rec(9054, 7027, 6015, 154),
        55 => detail_rec(9055, 7028, 6021, 255),
        56 => detail_rec(9056, 7028, 6002, 669),
        57 => detail_rec(9057, 7029, 6027, 778),
        58 => detail_rec(9058, 7029, 6028, 589),
        59 => detail_rec(9059, 7030, 6030, 235),
        60 => detail_rec(9060, 7030, 6009, 7561)
    );
